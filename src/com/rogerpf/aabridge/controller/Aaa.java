...
public class Aaa {
	...
	public static final Color       tooltipYellow       = new Color(254, 254, 206);
	
	public static final Color       scoreaaBBest        = new Color(200, 240, 190);
	public static final Color       scoreaaBBestBrd     = new Color(  0, 125,   0);
	public static final Color       scoreaaBOthr        = new Color(244, 224,  90);
	public static final Color       scoreaaBOthrBrd     = new Color(160, 160,  0);
	
//	public static final Color       scoreBboMaking      = new Color(  0, 120,   0);
//	public static final Color       scoreBboDown        = new Color(160,   0,   0);
	
	public static final Color       scoreBboMaking      = new Color(210, 235,  220);
	public static final Color       scoreBboMakingBrd   = new Color(0,   1,  255);
	public static final Color       scoreBboDown        = new Color(245, 210,  210);
	public static final Color       scoreBboDownBrd     = new Color(255,   0,    0);


	
	public static final Color		vdarkGrayBg			= new Color(120, 120, 120);
	...
	public static final Color		backgroundDarkerCol	= new Color(230, 225, 225);
	...
	public static final Color       navPresetPlay       = new Color(210, 210, 240);
	...
	public static final Color		playedCardBlackDum	= new Color(140, 140, 140);
	public static final Color		playedCardBlack		= new Color(160, 160, 160);
	...
	public static final Color		handBkColorDummy	= new Color(202, 192, 192);
//	public static final Color		handBkColorDummy	= new Color(208, 202, 202);
	...
	public static final Color		pureWhite			= new Color(255, 255, 255);
...
//	public static final Color		questionPanelBkColor= new Color(240, 233, 233);
	public static final Color		questionPanelBkColor= new Color(240, 235, 235);
	...
	public static final String zd_dealer_script_marker = "zd";
	public static final String zg_merge_list_marker = "zg";
	public static final String sk_seat_kib_marker = "sk";

	/**   
	 */
	public static String extract_pbn_field(String data, String marker) {
		// ************************************************************************
		String m_start = "<" + marker + ">";
		String m_end = "</" + marker + ">";

		int from = data.indexOf(m_start);
		int to = data.indexOf(m_end);

		int len = to - from - m_start.length();

		if (from == -1 || to == -1 || len <= 0) {
			return "";
		}
	...
	public static String cleanString(String s, boolean spaceOk) {
		...
		if (s.length() > 0) {
			...
			for (char c : s.toCharArray()) {
				if ((spaceOk && c == ' ') || c == '.' || c == '-' || c == '\\' || Character.isJavaIdentifierPart(c)) {
					good.append(c);
				}
				else {
					good.append('_');
...
//			s = s.replace("@c", "@c");
	...
	public static void delete_all_but_the_newest_files(String folder, int keep) {
		// ==============================================================================================
		// Obtain the array of (file, timestamp) pairs.

		File[] files = new File(folder).listFiles();
		PairFT[] pairs = new PairFT[files.length];
		for (int i = 0; i < files.length; i++) {
			pairs[i] = new PairFT(files[i]);
		}
		...
		for (int i = keep; i < pairs.length; i++) {
			pairs[i].f.delete();
		}
//		int z = 0;
//		z++;
...
class PairFT implements Comparable<PairFT> {
	// ==============================================================================================
	public File f;
	public long t;

	public PairFT(File file) {
		f = file;
		t = file.lastModified();
	}

	public int compareTo(PairFT o) {
		return o.t < t ? -1 : o.t == t ? 0 : 1;
	}
};

class MissingLin implements Comparable<MissingLin> {
	// ==============================================================================================
	public File f;
	public long t;
	public long len;

	public MissingLin(File file) {
		f = file;
		t = file.lastModified();
		len = file.length();
	}
	...
	public int compareTo(MissingLin o) {
		return o.t < t ? 1 : o.t == t ? 0 : -1;  // oldest first
	}
};
