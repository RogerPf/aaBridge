...
//		bigHint_sd_e       = Aaf.gT("bigHint.sd_e"); 
		...
		menuFile_openSF_D  = fff + spacedOut(menuItem, Aaf.gT("menuFile.openSF"),  firstPartLen) + mid + Aaf.gT("menuFile.quotesA");	
		...
		menuFile_impSF_D   = fff + spacedOut(menuItem, Aaf.gT("menuFile.impSF"),   firstPartLen) + mid + Aaf.gT("menuFile.imp_2");		
		menuFile_impTMF_D  = fff + spacedOut(menuItem, Aaf.gT("menuFile.impTMF"),  firstPartLen) + mid + Aaf.gT("menuFile.quotesA");		
		menuFile_impTOF_D  = fff + spacedOut(menuItem, Aaf.gT("menuFile.impTOF"),  firstPartLen) + mid + Aaf.gT("menuFile.quotesA");
		menuFile_openDLF_D = mid + spacedOut(menuItem, Aaf.gT("menuFile.openDLF"), firstPartLen) + mid + Aaf.gT("menuFile.openDLF_2");
