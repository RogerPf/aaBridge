...
public class Aaf {
	...
	public static String  cmdBar_cont         = "";
	public static String  cmdBar_dds          = "";
	public static String  cmdBar_cont_TT      = "";
	public static String  cmdBar_dds_TT       = "";
	...
	public static String  splash_dcEr1        = "";
	public static String  splash_dcEr2        = "";
	public static String  splash_dcOk1        = "";
	...
	public static String  bigHint_sd_a        = "";
	public static String  bigHint_sd_sd       = "";
	public static String  bigHint_sd_b        = "";
	public static String  bigHint_sd_c        = "";
//	public static String  bigHint_sd_d        = "";
//	public static String  bigHint_sd_e        = "";
	...
	public static String  bigHint_UB          = "";
	...
	public static String  menuFile_openAAB_D  = "";
	public static String  menuFile_openTMF_D  = "";
	
	public static String  menuFile_openTOF_D  = "";
	public static String  menuFile_openDLF_D  = "";
	
	public static String  menuFile_impSF_D   = "";
	public static String  menuFile_impTMF_D  = "";
	public static String  menuFile_impTOF_D  = "";
	public static String  menuFile_impDLF_D  = "";
	...
	private static void readCachedStrings() {
		...
		splash_dcEr1	   = Aaf.gT("splash.dcEr1");
		splash_dcEr2	   = Aaf.gT("splash.dcEr2");
		splash_dcOk1	   = Aaf.gT("splash.dcOk1");
		...
		bigHint_sd_a       = Aaf.gT("bigHint.sd_a"); 
		bigHint_sd_sd      = Aaf.gT("bigHint.sd_sd"); 
		bigHint_sd_b       = Aaf.gT("bigHint.sd_b"); 
		bigHint_sd_c       = Aaf.gT("bigHint.sd_c"); 
//		bigHint_sd_d       = Aaf.gT("bigHint.sd_d"); 
//		bigHint_sd_e       = Aaf.gT("bigHint.sd_e"); 
	...
	//	String fff = "     ";
		String mid = "     ";
		int firstPartLen = Aaf.getMetricsLength(menuItem, Aaf.gT("menuFile.space")) + App.menuTabExtra;		
		...
		menuFile_openAAB_D = spacedOut(menuItem, Aaf.gT("menuFile.openAAB"), firstPartLen) + " " + Aaf.gT("menuFile.openAAB_2");
		menuFile_openSF_D  = mid + mid + mid + mid + " " + spacedOut(menuItem, Aaf.gT("menuFile.openSF"),  firstPartLen) + mid + Aaf.gT("menuFile.quotesA");	
//		menuFile_openTMF_D = fff + spacedOut(menuItem, Aaf.gT("menuFile.openTMF"), firstPartLen) + mid + Aaf.gT("menuFile.quotesA");		
//		menuFile_openTOF_D = fff + spacedOut(menuItem, Aaf.gT("menuFile.openTOF"), firstPartLen) + mid + Aaf.gT("menuFile.quotesA");
		menuFile_impSF_D   = spacedOut(menuItem, Aaf.gT("menuFile.impSF"),   firstPartLen) + mid + Aaf.gT("menuFile.imp_2");		
		menuFile_impTMF_D  = spacedOut(menuItem, Aaf.gT("menuFile.impTMF"),  firstPartLen) + mid + "          " + Aaf.gT("menuFile.quotesA");		
		menuFile_impTOF_D  = spacedOut(menuItem, Aaf.gT("menuFile.impTOF"),  firstPartLen) + mid + "          " + Aaf.gT("menuFile.quotesA");
		menuFile_openDLF_D = spacedOut(menuItem, Aaf.gT("menuFile.openDLF"), firstPartLen) + mid + Aaf.gT("menuFile.openDLF_2");
		...
		cmdBar_cont        = Aaf.gT("cmdBar.contdds_c");
		cmdBar_dds         = Aaf.gT("cmdBar.contdds_d");
		cmdBar_cont_TT     = Aaf.gT("cmdBar.contdds_c_TT");
		cmdBar_dds_TT      = Aaf.gT("cmdBar.contdds_d_TT");
...
// 		iso_lang_OS = "pt_PT";  // testing only
	...
	private static String check_for_br(String sClean) {
		// =============================================================
		if (sClean.contains("<br>"))
			return "<html>" + sClean + "</html>";
		else
			return sClean;
	}
