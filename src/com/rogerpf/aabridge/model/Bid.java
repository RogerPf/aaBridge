...
public class Bid {
	...
	public Bid(Level level, Suit suit) {
		assert (level == Level.One || level == Level.Two || level == Level.Three || level == Level.Four || level == Level.Five || level == Level.Six
				|| level == Level.Seven);
	...
	public boolean isValid() {
		return (call == Call.RealBid || call == Call.Pass || call == Call.Double || call == Call.ReDouble);
	}
