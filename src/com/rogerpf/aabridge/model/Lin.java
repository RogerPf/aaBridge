...
//			}
	...
	static String pf_injector_text__rem_button = 
			...
			+ "button to remove all restrictions on  { ^*b 1st ^*n }   { ^*b Cont ^*n }  and  { ^*b Enter the Deal ^*n }";
...
//				linDealer = (((linDealer - 1) + rotate) % 4) + 1;
				...
				int offset = ((linDealer + 1) + kib_offset_from_dealer +  sk_pbn.v + 4 /* lin dealer has the rotate already */) % 4;
