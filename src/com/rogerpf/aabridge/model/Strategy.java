...
class StraStep {
	...
	StraStep(String idea, String cause, Rank rankRel, Suit suit, Dir compass) { // constructor
		// ==============================================================================================
	...
	Card getAdvisedCard(Hand h) {
		// ==============================================================================================
		return (rankRel == Rank.Invalid) ? null : h.getCardIfMatchingRankRel(suit, rankRel);
	}
}
...
public class Strategy extends ArrayList<StraStep> {
	...
	public static final String PlayCrd = "PlayCrd";
	...
	public boolean containsGetToHand(Dir compass) {
		// ==============================================================================================
	 ...
	 * 
	 * @param d   a deepclone of the current deal that the strategy keeps for its life
	 */
	Strategy(Deal d, Hand hExt) { // constructor
		// ==============================================================================================
		this.d = d;
		this.hExt = hExt;
		this.h = d.hands[hExt.compass.v]; // reminds us that every Stratergy is focused on a hand
...
//		 System.out.println(s + "Strategy Created  " + d.countCardsPlayed() + "  " + Dir.axisStr(h.axis()) + "  Tk " + (d.countCardsPlayed() / 4 + 1) + " "
//		 + Zzz.playOrd_st[d.countCardsPlayed() % 4]);

		if (h.axis() == d.contractAxis()) {
			// This is INITIAL declarer strategy **********
			// drawTrumpsHint = (d.contract.suit != Sue.NoTrumps); // assumed
		}
		else {
...
//		 String s = (d.testId == 0) ? "" : "test_" + d.testId + " ";
//		 System.out.println(s + "Strgy Upd  Tk " + (d.countCardsPlayed() / 4) + "  " + Dir.compass_to_nesw_str[h.compass.v] + " "
//		 + Zzz.playOrd_st[d.countCardsPlayed() % 4]);
