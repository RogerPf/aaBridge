 ...
 */
public class deal extends Structure {
	public int trump;
	public int first;
	/** C type : int[3] */
	 ...
	 * @param remainCards C type : unsigned int[4][4]
	 */
	public deal(int trump, int first, int currentTrickSuit[], int currentTrickRank[], int remainCards[]) {
		super();
		this.trump = trump;
		this.first = first;
