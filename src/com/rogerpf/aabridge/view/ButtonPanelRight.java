...
//	RpfResizeButton hiddenHandsClick2_b;
	...
	ButtonPanelRight() { /* Constructor */
		...
		String tt1 = Aaf.gT("rhp.fourSymbols");
		tt1 = tt1.substring(0,tt1.length() - 7);
		String tt2 = ddsStyle_btn.getToolTipText().substring(6); // remove the <html> I added [sigh]
		ddsStyle_btn.setToolTipText( tt1 + tt2);
