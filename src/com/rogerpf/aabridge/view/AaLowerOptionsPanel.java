...
//		}		
		...
		b2.add(label = new QLabel("______________________________", ""), "center");
		label.setBorder(BorderFactory.createEmptyBorder(2, 2, 0, 0));

		b2.add(pbnInfoFirst = new QCheckBox(this, App.pbnInfoFirst, Aaf.gT("botPanel.pbnInfoFirst"), Aaf.gT("botPanel.pbnInfoFirst_TT")), ", gapy 0, gapx 2");
