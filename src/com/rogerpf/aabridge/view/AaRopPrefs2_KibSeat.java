...
//		setBackground(SystemColor.control);
	   ...
	   // ------------    Apply Defaults  ---------------     
		...
		add(applyDefaults = new QButton(this, Aaf.gT("cmnTab.applyDef")), "gapx 2, " + (App.onMac ? "gapy8" : (App.study_deal_maker ? "gapy20" : "gapy25")));
	    ...
	    add(labelPowerKib = new QLabel(Aaf.gT("sChoiceTab.powerKib"),""), (App.onMac ? "gapy8" : "gapy25"));
	        labelPowerKib.setForeground(Aaa.optionsTitleGreen);
	        labelPowerKib.setFont(slightlyBiggerFont);
		
	    // -----------    Rotate Power buttons   (twister)   
...
//		labelAe.setEnabled(en);

//		labelHoverMsg.setEnabled(en);
	}
