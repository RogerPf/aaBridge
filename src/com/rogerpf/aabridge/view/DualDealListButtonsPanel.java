	...
	public void matchToLin() {
		...
		for (DualDeal dd : App.mg.ddAy) {
			...
			if (!min) {
				...
				add(openDeal.reviewBtn = new PButton(this, openDeal.declarerCompass(), at), "wmin 52, wmax 52, gap 3" + ((ddAy.twoColumn) ? "" : ", wrap"));
				...
				add(closedDeal.reviewBtn = new PButton(this, closedDeal.declarerCompass(), at), "wmin 52, wmax 52, gap 3");
