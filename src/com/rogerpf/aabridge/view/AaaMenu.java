...
//		menu.add(menuItem);
		...
		menuItem.setForeground(Cc.GreenStrong);
		menuItem.setActionCommand("web_aaBridgeWebSite");
		menuItem.addActionListener(listener);
		menu.add(menuItem);

		// Google Drive
		menuItem = new JMenuItem(Aaf.spacedOut(menuItem, "", firstPartLen) + Aaf.gT("helpMenu.aaBGDrive"));
		menuItem.setActionCommand("web_ArchiveGoogleDrive");
		menuItem.addActionListener(listener);
		menu.add(menuItem);

//		// Facebook
//		menuItem = new JMenuItem(Aaf.spacedOut(menuItem, "", firstPartLen) + Aaf.gT("helpMenu.aaBFacebook"));
