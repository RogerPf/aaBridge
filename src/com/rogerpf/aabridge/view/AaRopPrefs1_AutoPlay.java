...
//		    
//		add(forceYouSeatToSouthZone = new QCheckBox(this, App.forceYouSeatToSouthZone,  "Force You Seat  'South'   -   When  Entering a Deal always make the 'South Zone' the You Seat  "), "gapy 3");
//		    forceYouSeatToSouthZone.setBorder(bdr2);
//		    forceYouSeatToSouthZone.setForeground(Cc.RedStrong);
//	   		    
//			add(anyLabel       = new QLabel("Override"), (App.onMac ? "gapy8" : "gapy16"));
//			anyLabel.setForeground(Aaa.optionsTitleGreen);
//
//		add(forceShowEtd = new QCheckBox(this, App.forceShowEtd,  "Show 'Enter the Deal'       Overrides suppression of 'Enter the Deal' visibility"));
