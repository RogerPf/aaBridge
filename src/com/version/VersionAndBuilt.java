...
public class VersionAndBuilt {
	static int prob_fmt_req_numb = /* best to leave this alone ... best to leave THIS setting alone unless */5172;// compatibility needed
	
	static String ver = "5.1.0.";  public static String devExtra = "";    // extra is dev only, normally null

	public static int buildNo = 5212;    static String y = "2019", m = "May", d = "06";
